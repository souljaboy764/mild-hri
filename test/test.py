...
for model_type in model_types:
	for epoch in epochs:
		...
		for trial in range(4):
			...
			s = f'{model_type[-4:]}\t{epoch}\t{trial}\t{np.mean(pred_mse_ckpt):.4e}\t{np.std(pred_mse_ckpt):.4e}\t{np.mean(pred_mse_nowave_ckpt):.4e}\t{np.std(pred_mse_nowave_ckpt):.4e}'
		...
		s = f'{model_type[-4:]}\t{epoch}\tall\t{np.mean(pred_mse_k):.4e}\t{np.std(pred_mse_k):.4e}\t{np.mean(pred_mse_nowave_k):.4e}\t{np.std(pred_mse_nowave_k):.4e}'
